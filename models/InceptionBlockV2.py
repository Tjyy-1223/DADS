...
class InceptionBlockV2(nn.Module):
    ...
    """
    def __init__(self,
                 in_channels:int = 3,ch1x1: int = 64,ch3x3red: int = 64,
                 ch3x3: int = 96, ch3x3_double_red: int = 64, ch3x3_double: int = 96,
        ...
        self.branch3 = nn.Sequential(
            conv_block(out_pre_channels, ch3x3_double_red, kernel_size=1),
            conv_block(ch3x3_double_red, ch3x3, kernel_size=3, padding=1),
...
def construct_edge_cloud_inception_block(model: InceptionBlockV2, model_partition_edge: list):
    """
